/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-twilight&languages=markup+css+clike+javascript+aspnet+basic+c+csharp+cpp+clojure+coffeescript+dart+django+docker+elixir+excel-formula+fsharp+go+haskell+java+json+lua+markup-templating+objectivec+ocaml+perl+php+python+r+jsx+tsx+ruby+rust+sql+swift+typescript+vbnet+visual-basic+wasm+yaml+zig&plugins=line-highlight+line-numbers+highlight-keywords */
var _self =
